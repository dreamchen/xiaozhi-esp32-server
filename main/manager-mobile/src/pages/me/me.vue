<template>
	<view class="wrapper">
		<view class="head">
			<view class="head-info" @click="gotoLogin">
				<image class="info-img" src="/static/logo.png"></image>
				<view class="info-txt">{{userInfo.token?userInfo.username:'未登录'}}</view>
			</view>
		</view>
		<view class="menu">
			<view class="menu-item" @click="gotoVoice">
				<view class="item-l"><i class="fas fa-volume-up"></i></view>
				<view class="item-m">声音复刻</view>
				<view class="item-r"><i class="fas fa-chevron-right"></i></view>
			</view>
			<view class="menu-item" @click="gotoContact">
				<view class="item-l"><i class="fas fa-headset"></i></view>
				<view class="item-m">联系我们</view>
				<view class="item-r"><i class="fas fa-chevron-right"></i></view>
			</view>
			<view class="menu-item" @click="logout">
				<view class="item-l"><i class="far fa-trash-alt"></i></view>
				<view class="item-m">退出</view>
				<!-- <view class="item-r"><i class="fas fa-chevron-right"></i></view> -->
			</view>
		</view>
		<view class="version" @longpress="clearStorage">v{{version}}</view>
	</view>
	<!-- 提示信息弹窗 -->
...
<script>
	export default {
		data() {
			return {
				msgType: 'success',
				messageText: '移动端功能开发中，敬请期待…',
				version: getApp().globalData.appInfo.version,
				userInfo: {}
			}
		},
		onLoad() {
			...
			getUserInfo() {
				API.getUserInfo(({data})=>{
					if(data.code===0){
						...
						try {
							uni.setStorageSync('userInfo', _userInfo); //存入缓存
						} catch (e) {
							// error
						}
					}else{
						messageToggle("warn","获取用户信息失败,"+data.msg);
					}
				})
			},
			logout() {
