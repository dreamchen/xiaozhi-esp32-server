...
//                referenceAudio = voiceClone.getReferenceAudio();
//                referenceText = voiceClone.getReferenceText();
            }
        } else {
            //官方音色
    ...
    private void buildModuleConfig(
        ...
        if (StringUtils.isNotBlank(prompt)) {
            prompt = prompt.replace("{{assistant_name}}", StringUtils.isBlank(assistantName) ? "小优" : assistantName);
        }
